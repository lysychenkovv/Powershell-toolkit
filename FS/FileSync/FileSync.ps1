<#
.SYNOPSIS
Synchronizes files and folders between source and target locations.

.DESCRIPTION
Supports XML configuration files, multiple targets, exclusions,
filters, logging, reporting and WhatIf mode.
...
.TAGS
FileSync,Backup,Filesystem,Automation

.NOTES
Supports multiple target locations and XML configuration files.
#>
